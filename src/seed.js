...
function createTestUsers() {
    return __awaiter(this, void 0, void 0, function () {
        var users, _i, users_1, user, _a, data, error;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (error) {
                        console.error("Error creating user with matricula ".concat(user.matricula, ":"), error.message);
                    }
                    else {
                        console.log("User created with matricula ".concat(user.matricula, ":"), data.user);
                    }
                    _b.label = 3;
                case 3:
                    _i++;
